...
/**
 * Method is called by Connection.end for each PreparedStatement, to enqueue the
 * DEALOCATE-query to free up server-side ressources. Reference to and in the
 * parrent Connection will be removed, when no error occurs. Console output is
 * only shown, if this.debug is true.
 * @returns {undefined}
 */
...
/**
 * Create a unique variablename for the statrments
